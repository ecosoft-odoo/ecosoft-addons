...
class ResConfigSettings(models.TransientModel):
    ...
    def _onchange_zort_connector_enabled(self):
        if not self.zort_connector_enabled:
            self.env['ir.config_parameter'].sudo().set_param('zort_connector.endpoint_url', '')
            self.env['ir.config_parameter'].sudo().set_param('zort_connector.api_key', '')
            self.env['ir.config_parameter'].sudo().set_param('zort_connector.api_secret', '')
            self.env['ir.config_parameter'].sudo().set_param('zort_connector.store_name', '')
