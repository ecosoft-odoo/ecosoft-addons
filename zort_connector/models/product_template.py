    ...
    def action_update_create_product_on_zort(self):
        ...
        try:
            ...
            self._log_api_response(response_json={
                ...
                }, func='action_update_create_zort', path='zort_connector/models/product_template.py', line=16)
            ...
            self._log_api_response(response_json={
                ...
                'status': 'error',
                'error': str(e)
            }, func='action_update_create_zort', level='error', path='zort_connector/models/product_template.py', line=16)
